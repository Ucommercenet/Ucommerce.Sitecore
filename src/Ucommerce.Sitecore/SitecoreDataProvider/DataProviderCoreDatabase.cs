	...
	public class DataProviderCoreDatabase : DataProviderAllDatabases
	{
		...
		public override ItemDefinition GetItemDefinition(ID itemId, CallContext context)
		{
			...
			if (itemId == FieldIds.SystemContent.UcommerceProductsMultilistWithSearch)
			{
				...
				return new ItemDefinition(itemId, SitecoreConstants.FieldTypeProductsTreeListWithSearch, TemplateIDs.TemplateFieldType, ID.Null);
			}
			...
			if (itemId == FieldIds.SystemContent.UcommerceCategoriesTreeList)
			{
				...
				return new ItemDefinition(itemId, SitecoreConstants.FieldTypeCategoriesTreeList, TemplateIDs.TemplateFieldType, ID.Null);
			}
