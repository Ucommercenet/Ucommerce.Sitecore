...
namespace Ucommerce.Sitecore.Installer.Steps
{
    public class MoveUcommerceBinaries : IPostStep
    {
        ...
        public MoveUcommerceBinaries(IInstallerLoggingService loggingService)
        {
        ...
        public void Run(ITaskOutput output, NameValueCollection metaData)
        {
            ...
            _postInstallationSteps.Add(new DeleteFile("~/bin/Ucommerce.Sitecore.CommerceConnect.dll", _loggingService));

            _postInstallationSteps.Add(new MoveFile(
                "~/bin/ucommerce/Ucommerce.Infrastructure.dll",
                "~/bin/Ucommerce.Infrastructure.dll",
                backupTarget: false, _loggingService));
